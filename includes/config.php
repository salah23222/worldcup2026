...
// كاش النتائج اللحظية بالثواني — توازن دقيق بين «حيوية النتيجة» و«حصّة API-Football».
// 120 = نصف الاستهلاك مقابل تأخّر مقبول (دقيقتان كحد أقصى).
// لو Free plan (100/يوم): اجعلها 300 لتُخفّض الاستهلاك أكثر.
// لو PRO plan (7,500/يوم): اجعلها 60 لتجربة أكثر حيويّة.
